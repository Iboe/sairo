...
/**
 * Base class for common {@link Task} serialization. Each {@link Task} to be supported
 ...
 * @param <T> Derived classes must specify a the {@link Task} implementation class as template parameter, whose objects shall be serialized. 
 * 
 * @author Michael Kant
 */
public abstract class SerializedTaskBase<T extends Task> implements SerializedTask {
	...
	/**
	 * Provides the {@link Task} class that's associated to this {@link SerializedTask}.<br>
	 * The {@link Task} class is just returned, if a {@link Task} object is associated to this {@link SerializedTask}.<br>
	 * If no {@link Task} object is referenced due to bad serial data, this method will return null. 
	 * @return The {@link Task} of the associated {@link Task} object, or <code>null</code> if this {@link SerializedTask} is invalid.
	 */
	@Override
	...
	/**
	 * Returns the serialized form of the associated {@link Task} including the checksum. If it doesn't exist yet, it will be generated by {@link #getTaskData()}.
	 * 
	 * @return The serialized data with with the checksum bit at the end.
	 */
	@Override
	...
	/**
	 * Returns the associated {@link Task} object. <br>
	 * If it doesn't exist yet, it will be created by {@link #deserializeTask(byte[])}.<br>
	 * <code>null</code> is returned, if no {@link Task} object was referenced and {@link #deserializeTask(byte[])} returned <code>null</code> too.
	 * 
	 * @return The associated {@link Task} object. 
	 */
	@Override
	public T getTask() {
