...
public class MissionCreatorLogic {
    ...
    public void missionTree_NewPropellorFullForward_Task(JTree missionTree, String name) {
        Task load = new de.fhb.sailboat.mission.PrimitiveCommandTask(null, null, GUIController.PROPELLOR_MAX);
    ...
    public void missionTree_NewPropellorStop_Task(JTree missionTree, String name) {
        Task load = new de.fhb.sailboat.mission.PrimitiveCommandTask(null, null, GUIController.PROPELLOR_STOP);
        missionTreeNew_Task(missionTree, name, load);
    }
    ...
    public void missionTree_NewPropellorFullBackward_Task(JTree missionTree, String name) {
        Task load = new de.fhb.sailboat.mission.PrimitiveCommandTask(null, null, GUIController.PROPELLOR_REVERSE);
        missionTreeNew_Task(missionTree, name, load);
    }
    ...
    public void missionTree_NewRudderRight_Task(JTree missionTree, String name) {
        Task load = new de.fhb.sailboat.mission.PrimitiveCommandTask(null, GUIController.RUDDER_RIGHT, null);
        missionTreeNew_Task(missionTree, name, load);
    }
    ...
    public void missionTree_NewRudderNeutral_Task(JTree missionTree, String name) {
        Task load = new de.fhb.sailboat.mission.PrimitiveCommandTask(null, GUIController.RUDDER_NORMAL, null);
        missionTreeNew_Task(missionTree, name, load);
    }
    ...
    public void missionTree_NewRudderLeft_Task(JTree missionTree, String name) {
        Task load = new de.fhb.sailboat.mission.PrimitiveCommandTask(null, GUIController.RUDDER_LEFT, null);
        missionTreeNew_Task(missionTree, name, load);
    }
