...
//			if (DriveAngleMode.COMPASS.equals(mode)) {
				...
				LOG.debug("Calculate deltaAngle with desired angle: " + desiredAngle + " and compass.getAzimuth (id: " + compassModel.getCompass().getTimeStamp() +  "): " + compassModel.getCompass().getAzimuth()
						+ " = " + deltaAngle);
