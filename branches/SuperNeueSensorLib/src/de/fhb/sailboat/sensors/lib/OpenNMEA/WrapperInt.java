...
public class WrapperInt implements Wrapper
{
	...
	public WrapperInt(String s)
	{
		...
		catch(Exception e){value=Integer.MIN_VALUE;}
		description="";
	}
	...
	{
		try{value=new Integer(Integer.parseInt(s));}
		catch(Exception e){value=Integer.MIN_VALUE;}
		description=t;
	}
	...
	{
		return description+(description.equals("")?"":": ")+(value==Integer.MIN_VALUE?"NaN":value);
	}
}